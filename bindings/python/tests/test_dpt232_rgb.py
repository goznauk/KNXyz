...
pure DPT payload codec; live colour writes stay refused at knx-ip's
...
def test_dpt232_rgb_encodes_offline_and_round_trips():
    # the pure DPT payload codec now encodes RGB -> 3 bytes; this is not a live
    # write (colour actuation stays refused at knx-ip encode_value).
